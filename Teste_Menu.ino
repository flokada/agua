...
String menuItems[] = {"Brilho", "Relogio", "Menu Teste", "ITEM 4", "ITEM 5", "Suporte"};

// Navigation button variables
int readKey;
int savedDistance = 10;
float Brilho = 2.55*savedDistance;
...
void setup() {
  ...
  lcd.begin(16, 2);
  lcd.clear();
  analogWrite (10, Brilho); //Brilho do LCD de 0 a 255
  ...
  while (activeButton == 0) {
    ...
    switch (button) {
      case 2:
        ...
        savedDistance = constrain(savedDistance,0,100);
        Brilho = 2.55*savedDistance;
        lcd.setCursor(8,0);
        lcd.print("     ");
        lcd.setCursor(8,0);        
        lcd.print(savedDistance);
